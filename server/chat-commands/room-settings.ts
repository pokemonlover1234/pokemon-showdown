...
export const commands: Chat.ChatCommands = {
	...
	makegroupchat(target, room, user, connection, cmd) {
		...
		const targetRoom = Rooms.createChatRoom(roomid, `[G] ${title}`, {
			...
			auth: {},
			introMessage: `` +
				`<div style="text-align: center"><table style="margin:auto;"><tr><td><img src="${Dex.fxPrefix}groupchat.png" width=120 height=100></td><td><h2>${titleMsg}</h2><p>Follow the <a href="/rules">Pokémon Showdown Global Rules</a>!<br>Don't be disruptive to the rest of the site.</p></td></tr></table></div>`,
			staffMessage: `` +
