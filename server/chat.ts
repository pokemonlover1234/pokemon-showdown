...
export const Chat = new class {
	...
	getDataMoveHTML(move: Move, isChampions = false) {
		...
		buf += `<span class="col typecol"><img src="${Dex.resourcePrefix}sprites/types/${encodedMoveType}.png" alt="${move.type}" width="32" height="14">`;
		buf += `<img src="${Dex.resourcePrefix}sprites/categories/${move.category}.png" alt="${move.category}" width="32" height="14"></span> `;
		if (move.basePower) {
