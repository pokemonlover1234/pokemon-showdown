...
export const TrademarkedScripts: ModdedBattleScriptsData = {
	gen: 9,
	inherit: 'gen9',
	endTurn() {
		this.turn++;
...
export interface CustomsMap {
	scripts: ModdedBattleScriptsData | null;
}

interface CustomsDict {
	[key: string]: CustomsMap;
}

export const OMMap: CustomsDict = {
	"trademarked": {
		"scripts": TrademarkedScripts,
	},
};
