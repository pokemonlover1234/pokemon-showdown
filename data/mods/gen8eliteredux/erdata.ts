...
import { SpeciesListSchema } from "./er-proto/SpeciesList_pb";
import speciesData from "./er-json/SpeciesList.json";

const species = fromJson(SpeciesListSchema, speciesData);
